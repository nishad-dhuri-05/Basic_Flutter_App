...
Widget _defaultHome=const OTPPage();//newly added
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        routes: {
          ...
          '/login':(context)=>LoginPage(data: ""),
          '/register': (context) => RegisterPage(data: ""),
          '/home':(context)=> const HomePage(),
          'update':(context)=> ProfileUpdate(email: "", name: "", contact: "", address: "")
          //'/home':(context)=> const HomePage(),
          });
  }
}
